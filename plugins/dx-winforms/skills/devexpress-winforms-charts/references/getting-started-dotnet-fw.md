...
```powershell
# SDK-style project
dotnet add package DevExpress.Win.Charts
...
> Both commands above add the required assembly references. The `DevExpress.Win` umbrella package also includes Charts.
