...
- DevExpress NuGet feed configured at `https://nuget.devexpress.com/api`
...
In Visual Studio: **Tools → NuGet Package Manager → Package Manager Settings → Package Sources** → add `https://nuget.devexpress.com/api`.
...
### Step 3: Add the Namespace Import
