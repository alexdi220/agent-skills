...
compatibility: Requires .NET 6+ or .NET Framework 4.6.2+. NuGet packages from the DevExpress feed. DevExpress.Pdf.SkiaRenderer required for rendering on .NET 6+.
metadata:
  author: DevExpress
  version: "25.2"
