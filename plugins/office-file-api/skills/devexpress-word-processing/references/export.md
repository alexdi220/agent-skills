...
```csharp
options.PdfUACompatibility = PdfUACompatibility.PdfUA1; // ISO 14289
```
...
|---------|-------|----------|
| `FileNotFoundException` for SkiaSharp on .NET 6+ | Missing PDF renderer | Install `DevExpress.Pdf.SkiaRenderer` NuGet package |
