---
name: devexpress-ai-powered-extensions
...
compatibility: Requires .NET 8+ or .NET Framework 4.7.2. An AI provider account (Azure OpenAI, OpenAI, Ollama, or other IChatClient-compatible provider) is required.
metadata:
  author: DevExpress
  version: "25.2"
